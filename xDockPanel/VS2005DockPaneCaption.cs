...
namespace xDockPanel
{
    internal class VS2005DockPaneCaption : DockPaneCaptionBase
    {
        ...
        private static Bitmap ImageButtonClose
        {
            get
            {
                if (_imageButtonClose == null)
                    _imageButtonClose = Properties.Resources.DockPane_Close;
        ...
        private static Bitmap ImageButtonAutoHide
        {
            get
            {
                if (_imageButtonAutoHide == null)
                    _imageButtonAutoHide = Properties.Resources.DockPane_Dock;
        ...
        private static Bitmap ImageButtonDock
        {
            get
            {
                if (_imageButtonDock == null)
                    _imageButtonDock = Properties.Resources.DockPane_AutoHide;
        ...
        private static Bitmap ImageButtonOptions
        {
            get
            {
                if (_imageButtonOptions == null)
                    _imageButtonOptions = Properties.Resources.DockPane_Option;
        ...
        private void DrawCaption(Graphics g)
        {
            ...
            TextRenderer.DrawText(g, DockPane.CaptionText, TextFont, rectCaptionText, colorText, TextFormat);
        }
        ...
        private void SetButtonsPosition()
        {
            ...
            ButtonAutoHide.Bounds = new Rectangle(point, buttonSize);
            if (ShouldShowAutoHideButton)
                point.Offset(-(buttonWidth + ButtonGapBetween), 0);
            ButtonOptions.Bounds = new Rectangle(point, buttonSize);
        }
