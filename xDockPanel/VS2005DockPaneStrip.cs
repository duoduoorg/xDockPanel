...
namespace xDockPanel
{
    internal class VS2005DockPaneStrip : DockPaneStripBase
    {
        ...
        private static Bitmap ImageButtonClose
        {
            get
            {
                if (m_imageButtonClose == null)
                    m_imageButtonClose = Properties.Resources.DockPane_Close;
        ...
        private static Bitmap ImageButtonWindowList
        {
            get
            {
                if (m_imageButtonWindowList == null)
                    m_imageButtonWindowList = Properties.Resources.DockPane_Option;
        ...
        private static Bitmap ImageButtonWindowListOverflow
        {
            get
            {
                if (m_imageButtonWindowListOverflow == null)
                    m_imageButtonWindowListOverflow = Properties.Resources.DockPane_OptionOverflow;
        ...
        private GraphicsPath GetOutline_Document(int index)
        {
            ...
            rectTab = RectangleToScreen(rectTab);
            Rectangle rectPaneClient = DockPane.RectangleToScreen(DockPane.ClientRectangle);

            GraphicsPath path = new GraphicsPath();
            GraphicsPath pathTab = GetTabOutline_Document(Tabs[index], true, true);
        ...
        private GraphicsPath GetOutline_ToolWindow(int index)
        {
            ...
            GraphicsPath path = new GraphicsPath();
            GraphicsPath pathTab = GetTabOutline(Tabs[index], true);
            path.AddPath(pathTab, true);
        ...
        private GraphicsPath GetTabOutline(Tab tab, bool toScreen)
        {
            if (Appearance == DockPane.AppearanceStyle.ToolWindow)
                return GetTabOutline_ToolWindow(tab, toScreen);
            else
                return GetTabOutline_Document(tab, toScreen, false);
        }

        private GraphicsPath GetTabOutline_ToolWindow(Tab tab, bool toScreen)
        {
        ...
        private GraphicsPath GetTabOutline_Document(Tab tab, bool toScreen, bool full)
        {
            int curveSize = 6;
            GraphicsPath.Reset();
            Rectangle rect = GetTabRectangle(Tabs.IndexOf(tab));
        ...
        private void DrawTab_ToolWindow(Graphics g, TabVS2005 tab, Rectangle rect)
        {
            ...
            else
            {
                ...
                if (Tabs.IndexOf(DockPane.ActiveContent) != Tabs.IndexOf(tab) + 1)
                {
                    ...
                    g.DrawLine(PenToolWindowTabBorder, pt1, pt2);
                }
        ...
        private void LayoutButtons()
        {
            ...
            ButtonClose.Bounds = new Rectangle(point, buttonSize);
            ...
            ButtonWindowList.Bounds = new Rectangle(point, buttonSize);
        }
