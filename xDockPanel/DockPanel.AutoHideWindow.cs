        ...
        private class AutoHideWindowControl : Panel, ISplitterDragSource
        {
            ...
            public IDockContent ActiveContent
            {
                ...
                set
                {
                    ...
                    if (value != null)
                    {
                        if (!DockHelper.IsDockAutoHide(value.DockHandler.DockState) || value.DockHandler.DockPanel != DockPanel)
                            return;
                    }
            ...
            protected virtual Rectangle DisplayingRectangle
            {
                get
                {
                    ...
                    if (DockState == DockState.AutoHideBottom)
                    {
            ...
            public void RefreshActiveContent()
            {
                ...
                if (!DockHelper.IsDockAutoHide(ActiveContent.DockHandler.DockState))
                {
                    FlagAnimate = false;
                    ActiveContent = null;
                    FlagAnimate = true;
            ...
            {
                get { return (DockState == DockState.AutoHideLeft || DockState == DockState.AutoHideRight); }
            }
            ...
            void ISplitterDragSource.MoveSplitter(int offset)
            {
                ...
                if (DockState == DockState.AutoHideLeft && rectDockArea.Width > 0)
                {
                ...
                else if (DockState == DockState.AutoHideRight && rectDockArea.Width > 0)
                {
                    if (content.DockHandler.AutoHidePortion < 1)
                        content.DockHandler.AutoHidePortion -= ((double)offset) / (double)rectDockArea.Width;
                    else
                ...
                else if (DockState == DockState.AutoHideBottom && rectDockArea.Height > 0)
                {
                    if (content.DockHandler.AutoHidePortion < 1)
                ...
                else if (DockState == DockState.AutoHideTop && rectDockArea.Height > 0)
                {
                    if (content.DockHandler.AutoHidePortion < 1)
                        content.DockHandler.AutoHidePortion += ((double)offset) / (double)rectDockArea.Height;
                    else
