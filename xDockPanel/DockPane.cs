...
namespace xDockPanel
{
    ...
    public partial class DockPane : UserControl, IDockDragSource
    {
        ...
        {
            get { return DockHelper.IsDockAutoHide(DockState); }
        }
        ...
        {
            if (DockHelper.IsDockAutoHide(DockState) && DockPanel.ActiveAutoHideContent != ActiveContent)
        ...
        private void RefreshChanges(bool performLayout)
        {
            ...
            if (DockHelper.IsDockAutoHide(DockState) && DockPanel != null)
            {
                DockPanel.RefreshAutoHideStrip();
                DockPanel.PerformLayout();
            }
        ...
        private void SetParent()
        {
            ...
            else if (DockHelper.IsDockAutoHide(DockState))
            {
        ...
        private void RefreshStateChange(INestedPanesContainer oldContainer, DockState oldDockState)
        {
            ...
            if (DockHelper.IsDockAutoHide(oldDockState))
        ...
        public DockPane DockTo(INestedPanesContainer container)
        {
            ...
            if (container.DockState == DockState.Left || container.DockState == DockState.Right)
        ...
        public void DockTo(DockPanel panel, DockStyle dockStyle)
        {
            ...
            if (dockStyle == DockStyle.Top)
                DockState = DockState.Top;
            else if (dockStyle == DockStyle.Bottom)
                DockState = DockState.Bottom;
            else if (dockStyle == DockStyle.Left)
                DockState = DockState.Left;
            else if (dockStyle == DockStyle.Right)
                DockState = DockState.Right;
