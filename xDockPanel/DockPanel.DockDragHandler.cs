    ...
    partial class DockPanel
    {
        private sealed class DockDragHandler : DragHandler
        {
            private class DockIndicator : DragForm
            {
                ...
                {
                    private static Image _imagePanelLeft = Properties.Resources.DockIndicator_PanelLeft;
                    private static Image _imagePanelRight = Properties.Resources.DockIndicator_PanelRight;
                    private static Image _imagePanelTop = Properties.Resources.DockIndicator_PanelTop;
                    private static Image _imagePanelBottom = Properties.Resources.DockIndicator_PanelBottom;
                    private static Image _imagePanelFill = Properties.Resources.DockIndicator_PanelFill;
                    private static Image _imagePanelLeftActive = Properties.Resources.DockIndicator_PanelLeft_Active;
                    private static Image _imagePanelRightActive = Properties.Resources.DockIndicator_PanelRight_Active;
                    private static Image _imagePanelTopActive = Properties.Resources.DockIndicator_PanelTop_Active;
                    private static Image _imagePanelBottomActive = Properties.Resources.DockIndicator_PanelBottom_Active;
                    private static Image _imagePanelFillActive = Properties.Resources.DockIndicator_PanelFill_Active;
                ...
                private class PaneIndicator : PictureBox, IHitTest
                {
                    ...
                    private static Bitmap _bitmapPaneDiamond = Properties.Resources.DockIndicator_PaneDiamond;
                    private static Bitmap _bitmapPaneDiamondLeft = Properties.Resources.DockIndicator_PaneDiamond_Left;
                    private static Bitmap _bitmapPaneDiamondRight = Properties.Resources.DockIndicator_PaneDiamond_Right;
                    private static Bitmap _bitmapPaneDiamondTop = Properties.Resources.DockIndicator_PaneDiamond_Top;
                    private static Bitmap _bitmapPaneDiamondBottom = Properties.Resources.DockIndicator_PaneDiamond_Bottom;
                    private static Bitmap _bitmapPaneDiamondFill = Properties.Resources.DockIndicator_PaneDiamond_Fill;
                    private static Bitmap _bitmapPaneDiamondHotSpot = Properties.Resources.DockIndicator_PaneDiamond_HotSpot;
                    private static Bitmap _bitmapPaneDiamondHotSpotIndex = Properties.Resources.DockIndicator_PaneDiamond_HotSpotIndex;
                    private static HotSpotIndex[] _hotSpots = new HotSpotIndex[]
            {
                ...
                private void RefreshChanges()
                {
                    ...
                    if (ShouldPanelIndicatorVisible(DockState.Left))
                    {
                    ...
                    if (ShouldPanelIndicatorVisible(DockState.Right))
                    {
                    ...
                    if (ShouldPanelIndicatorVisible(DockState.Top))
                    {
                    ...
                    if (ShouldPanelIndicatorVisible(DockState.Bottom))
                    {
            ...
            private class DockOutline : DockOutlineBase
            {
                ...
                private void SetOutline(DockPanel dockPanel, DockStyle dock, bool fullPanelEdge)
                {
                    ...
                    {
                        int height = dockPanel.GetDockWindowSize(DockState.Top);
                        rect = new Rectangle(rect.X, rect.Y, rect.Width, height);
                    }
                    else if (dock == DockStyle.Bottom)
                    {
                        int height = dockPanel.GetDockWindowSize(DockState.Bottom);
                        rect = new Rectangle(rect.X, rect.Bottom - height, rect.Width, height);
                    }
                    else if (dock == DockStyle.Left)
                    {
                        int width = dockPanel.GetDockWindowSize(DockState.Left);
                        rect = new Rectangle(rect.X, rect.Y, width, rect.Height);
                    }
                    else if (dock == DockStyle.Right)
                    {
                        int width = dockPanel.GetDockWindowSize(DockState.Right);
